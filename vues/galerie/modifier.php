        ...
        <section id="drag-area">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            <form action="/galerie/modification" method="post" class="form" enctype="multipart/form-data">
                                <input type="hidden" name="galerie" value="<?= $id ?>">
                                <div class="form-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <select class="select2 form-control" id="event" name="event">
                                                    ...
                                                    <?php foreach ($events as $event) : ?>
                                                        <option selected="<?= $one['evenements_id'] && $one['evenements_id'] === $event['id'] ?>" value="<?= $event['id'] ?>"><?= $event['libelle'] ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="select2 form-control" id="type" name="artiste[]" multiple>
                                                    ...
                                                    <?php foreach ($artistes as $artiste) : ?>
                                                        <option selected="<?= strpos($one['artistes_id'], $artiste['id']) !== false ?>" value="<?= $artiste['id'] ?>"><?= $artiste['name'] ?></option>
                                                    <?php endforeach; ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4 col-12">
                                            ...
                                            <input type="hidden" name="img" id="img" value="<?= $one['image'] ?>"/>
